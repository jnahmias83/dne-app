			...
			<div class="container">
				...
				<div class="margin-top-10-x-auto d-flex justify-content-center dir-rtl">
					<div id="div_btns_eval" class="bgColorBrown pt-3 px-3 pb-3 rounded-4 d-flex flex-wrap justify-content-center gap-3">
						<a class="border-black borderRadius10 padding-4x-4y bgColorWhite d-flex flex-column align-items-center justify-content-center text-decoration-none cursor-pointer" onclick="location.href='add_cost_eval.php?id=0&project_id=<?=@$project_id?>&lang_screen=<?=@$lang_screen?>'">

...
const isSortedKey = 'is_data_sorted_' + projectId;
const sort1Key = 'sort_select_1_' + projectId;
const sort2Key = 'sort_select_2_' + projectId;
const sort3Key = 'sort_select_3_' + projectId;
...
$(document).ready(function(){
	...
	const trackingKey = 'track_off_<?=$project_id?>';

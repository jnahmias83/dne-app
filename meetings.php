										...
										foreach($meetings as $item){
											...
											<tr id="row_<?=@$iteration?>" class="meeting_<?=@$meeting_id?>">
												...
												<td id="td_count_<?=@$meeting_id?>" class="alignCenter <?=@$border_cell_number?>" style="<?=@$td_count_bgcolor?>;">
													<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;height:100%;width:100%;max-width:80px;overflow:hidden;box-sizing:border-box;margin:0 auto;">

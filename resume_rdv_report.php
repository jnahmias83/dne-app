...
foreach($chapters as $item) {	
	...
	$query = $mysqli->prepare("SELECT m.id AS id,m.subject AS subject,m.id_rdv AS id_rdv,m.area AS area,m.description AS description,m.id_task AS id_task,m.id_responsible AS id_responsible,

...
if(isset($_POST['image1'])) {
    $image1_name = PATHINFO(BASENAME(@$_POST['image1_name']),PATHINFO_FILENAME).'_rotated_'.@$_POST['image1_rotation'].'.jpg';
    ...
    $image2_name = PATHINFO(BASENAME(@$_POST['image2_name']),PATHINFO_FILENAME).'_rotated_'.@$_POST['image2_rotation'].'.jpg';

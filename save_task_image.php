...
if(isset($_POST['image1'])) {
    $image1_name = PATHINFO(BASENAME(@$_POST['image1_name']),PATHINFO_FILENAME).'_rotated_'.@$_POST['image1_rotation'].'.png';
    $image1_data = $_POST['image1'];
    $image1_data = str_replace('data:image/png;base64,','',$image1_data);
    $image1_data = base64_decode($image1_data);
    $image1_path = 'uploads/'.$image1_name;
    $image1_type = pathinfo($image1_path,PATHINFO_EXTENSION); 		
    ...
    $image2_name = PATHINFO(BASENAME(@$_POST['image2_name']),PATHINFO_FILENAME).'_rotated_'.@$_POST['image2_rotation'].'.png';
    $image2_data = $_POST['image2'];
    $image2_data = str_replace('data:image/png;base64,','',$image2_data);
    $image2_data = base64_decode($image2_data);
    $image2_path = 'uploads/'.$image2_name;
    $image2_type = pathinfo($image2_path,PATHINFO_EXTENSION); 		

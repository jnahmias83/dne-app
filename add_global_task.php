...
?>
		...
		<form method="post" action="" enctype="multipart/form-data" class="form-inline">
			...
			<div class="container">
			    ...
			    <?php
				if($id == 0) { ?>
					<div class="row marginTop15 title fontSize23">
						<div class="col-md-12">			
						   הוסף סוג משימה
						</div>
					</div>
				<?php }
				   ...
				   <div class="row marginTop5 dir-rtl alignCenter">
						<div class="col-md-12 fontSize20">
							<span class="colorGreen"><?=@$task->name_he?></span>
						</div>
					</div>
				<?php } ?>			
				...
				<div class="row marginTop20 dir-rtl alignCenter">
					<div class="col-md-12">	
						<strong>שם</strong>
						<br/>	
						<input type="text" class="marginTop5 width250" name="name" id="name" placeholder="*שם" value="<?=@$task->name?>" />	
					</div>
				</div>
				<div class="row marginTop20 dir-rtl alignCenter">
					<div class="col-md-12">	
						...
						<br/>	
						<input type="text" class="marginTop5 width250" name="name_he" id="name_he" placeholder="*שם בעברית" value="<?=@$task->name_he?>" 

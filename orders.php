...
$(document).ready(function() {
   ...
   function setLabels() {
	  ...
	  if($('#lang').val() == 'EN') {
		  ...
		  $('#add_new_order_btn').html("<div class='alignCenter border-black borderRadius10 padding-4x-4y bgColorWhite cursor-pointer'><i class='fa-solid fa-plus colorGrey'></i><br/><strong class='fontSize13'>Order</strong></div>");
		  ...
		  $('#create_pdf_btn').css({"direction":"ltr","margin-right":"10px"});
		   ...
		   $('#add_new_order_btn').html("<div class='alignCenter border-black borderRadius10 padding-4x-4y bgColorWhite cursor-pointer'><i class='fa-solid fa-plus colorGrey'></i><br/><strong class='fontSize13'>הזמנה</strong></div>");
